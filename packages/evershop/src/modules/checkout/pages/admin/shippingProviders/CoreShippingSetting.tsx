  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Built-in shipping methods with per-zone rates. Attach Core to a zone
          first under Settings → Shipping; then add methods here and configure
          their rates per zone.
        </CardDescription>
      </CardHeader>
      <MethodsList />
    </Card>
