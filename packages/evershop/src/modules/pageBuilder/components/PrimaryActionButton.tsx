    ...
    return (
      <div ref={menuRef} className="relative inline-flex">
        <button
          ...
          title={
            hasUnsavedChanges
              ? 'Save your pending edits — the live storefront will catch up'
              : 'No changes to save — the rollout matches the editor'
          }
        ...
        {menuOpen && (
          ...
          >
            <PublishMenuItem
              ...
              description="Roll back the editor to what the rollout currently shows on the storefront"
              onClick={() => {
                setMenuOpen(false);
                onRevert();
              }}
              ...
              tooltip={
                hasUnsavedChanges
                  ? undefined
                  : 'Nothing to revert — the editor matches the saved state'
              }
            />
            ...
            <PublishMenuItem
              ...
              description="Remove the schedule — the changeset is preserved"
              onClick={() => {
                setMenuOpen(false);
                onCancelRollout();
              }}
